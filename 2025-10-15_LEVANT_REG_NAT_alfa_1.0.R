...
# 
# # 2. BURN TREATMENT DISTRIBUTION
# cat("\n=== BURN TREATMENT DISTRIBUTION ===\n")
# burn_counts <- clean_data[, .N, by = tratamento_queima]
# print(burn_counts)
# 
# # 3. SUMMARY STATISTICS BY BURN TREATMENT
# cat("\n=== VEGETATION COVER BY BURN TREATMENT ===\n")
...
# print(cover_by_burn)
# 
# # 4. VISUALIZATION - Distribution by burn treatment
# # Boxplots for each vegetation cover type by burn treatment
...
#   labs(title = "Woody Cover by Burn Treatment", x = "Burn Treatment", y = "Woody Cover (%)") +
#   theme_minimal()
# 
# p2 <- ggplot(clean_data, aes(x = tratamento_queima, y = nao_lenhoso, fill = tratamento_queima)) +
#   geom_boxplot(alpha = 0.7) +
#   scale_fill_manual(values = c("amarelo" = "yellow", "laranja" = "orange", "verde" = "green")) +
#   labs(title = "Non-Woody Cover by Burn Treatment", x = "Burn Treatment", y = "Non-Woody Cover (%)") +
#   theme_minimal()
# 
# p3 <- ggplot(clean_data, aes(x = tratamento_queima, y = solo_nu, fill = tratamento_queima)) +
#   geom_boxplot(alpha = 0.7) +
#   scale_fill_manual(values = c("amarelo" = "yellow", "laranja" = "orange", "verde" = "green")) +
#   labs(title = "Bare Soil by Burn Treatment", x = "Burn Treatment", y = "Bare Soil (%)") +
#   theme_minimal()
# 
# # Display plots
# print(p1)
...
# 
# # 6. EXPLORATORY ANALYSIS BY BURN TREATMENT
# cat("\n=== ANALYSIS BY BURN TREATMENT ===\n")
...
#   
#   if(nrow(burn_data) > 3) {
#     # Basic statistics for this burn treatment
...
# cat("\n=== KEY INSIGHTS ===\n")
# cat("1. Sample size by burn treatment:\n")
# print(burn_counts)
...
# 6. EXPLORATORY ANALYSIS BY BURN TREATMENT - FIXED VERSION
cat("\n=== ANALYSIS BY BURN TREATMENT ===\n")
burn_levels <- unique(clean_data$tratamento_queima)
